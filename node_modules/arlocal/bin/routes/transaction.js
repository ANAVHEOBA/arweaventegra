...
exports.deleteTxRoute = exports.txPendingRoute = exports.txDataRoute = exports.txRawDataRoute = exports.txFileRoute = exports.txFieldRoute = exports.txStatusRoute = exports.txPostRoute = exports.txOffsetRoute = exports.txRoute = exports.txAnchorRoute = exports.pathRegex = void 0;
            ...
            if (bundleFormat === 'binary' && bundleVersion === '2.0.0') {
                ...
                const createTxsFromItems = (buffer) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (let i = 0; i < items.length; i++) {
                        const item = items[i];
                        yield txPostRoute(Object.assign(Object.assign({}, ctx), { connection: ctx.connection, dbPath: ctx.dbPath, logging: ctx.logging, network: ctx.network, request: Object.assign(Object.assign({}, ctx.request), { body: Object.assign({ id: bundle.get(i).id, bundledIn: data.id }, item.toJSON()) }), txInBundle: true }));
                    }
                });
                if (data.data) {
...
function txPendingRoute(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const txIds = yield transactionDB.getUnminedTxs();
            ctx.status = 200;
            ctx.body = txIds;
        }
        catch (error) {
...
exports.txPendingRoute = txPendingRoute;
